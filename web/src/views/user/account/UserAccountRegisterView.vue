            ...
            <div class="col-3">
                <form @submit.prevent="register">
                    ...
                    <div class="mb-3">
                        ...
                        <input v-model="confirmedPassword" type="password" class="form-control" id="confirmedPassword" placeholder="Please, Confirm Password">
                    </div>
                    <div class="error-message">{{ error_message }}</div>
                    <button type="submit" class="btn btn-primary">Register In</button>
                </form>
            </div>
        </div>
    </ContentField>
    ...
    setup() {
        ...
        const register = () => {
            ...
            $.ajax({
                ...
                type: "post",
                contentType: 'application/json', // 确保 Content-Type 正确
                data: JSON.stringify({
                ...
                success(resp) {
                    if (resp.error_message === "register success") {
                        console.log(resp);
                        console.log('success');
